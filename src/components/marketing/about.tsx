...
export function About() {
  ...
  return (
    <section
      id="cara-kerja"
      className="flex flex-col items-center gap-25 bg-white px-20 py-25 max-md:gap-12 max-md:px-4 max-md:py-12 max-sm:px-3"
    >
      {/* Mission statement */}
      <div className="flex w-full max-w-[1224px] flex-col items-center gap-12 max-md:gap-8">
        <SectionDivider />
        <p
          ref={headlineRef}
          className={cn(
      ...
      <div
        ref={featuresRef}
        id="features"
        className="flex w-full max-w-[1280px] flex-col items-center gap-14 max-md:gap-10"
      >
        <div className="flex w-full flex-col items-center gap-8 max-md:gap-6">
          <SectionDivider />
          <div className="flex w-[min(714px,100%)] flex-col items-center gap-3 text-center max-md:px-2">
            <h2
              className={cn(
        ...
        <div className="grid w-full grid-cols-4 gap-4 max-[1100px]:grid-cols-2 max-[560px]:grid-cols-1 max-md:gap-3">
          {features.map((feature, i) => (
            ...
            >
              <Image
                ...
                width={38}
                height={38}
                className="size-[38px] max-sm:size-[32px]"
              />
              <div className="flex flex-col gap-2 text-left">
                <h3 className="m-0 font-serif text-[28px] font-normal leading-9 text-[var(--color-ink)] max-md:text-[24px] max-md:leading-8 max-sm:text-[20px] max-sm:leading-7">
                  {feature.title}
                </h3>
                <p className="font-body text-base font-normal leading-6 text-muted max-sm:text-sm max-sm:leading-5">
                  {feature.desc}
                </p>
              </div>
            </article>
